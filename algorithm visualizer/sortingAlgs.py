...
root.config(bg='dark olive green')
...
#frame / base lauout
UI_frame = Frame(root, width= 600, height=200, bg='SeaGreen3')
UI_frame.grid(row=0, column=0, padx=10, pady=5)

canvas = Canvas(root, width=600, height=380, bg='light yellow')
canvas.grid(row=1, column=0, padx=10, pady=5)

#User Interface Area
#Row[0]
Label(UI_frame, text="Algorithm: ", bg='sea green').grid(row=0, column=0, padx=5, pady=5, sticky=W)
...
Button(UI_frame, text="Start", command=StartAlgorithm, bg='tomato').grid(row=0, column=3, padx=5, pady=5)
...
Button(UI_frame, text="Generate", command=Generate, bg='violet red').grid(row=1, column=3, padx=5, pady=5)
